  ...
  response.send(`
    <html>
        ...
        <div style="margin: 2em;">
            ...
            <form action="https://asia-northeast3-flutter-flow-korea.cloudfunctions.net/run" method="POST">
...
export const run = functions
    ...
    // / get main.dart
      ...
      const jsUrl: string = regex.exec(html) as unknown as string;
      try {
        res = await axios.get(jsUrl);
      } catch (e) {
        console.log("error on getting the main.dart.js: " + jsUrl);
        console.log(e);
      ...
      const securyInfo: string = securyRegex.exec(js) as unknown as string;
